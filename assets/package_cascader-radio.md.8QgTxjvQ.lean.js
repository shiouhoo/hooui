import{d as c,h as d,D as y,o as F,b as u,w as e,k as i,t as C,m as r,a6 as B,c as v,I as E,R as m,a as s}from"./chunks/framework.2gZay9Je.js";const A=c({__name:"cascader-radio.md.demo.659f4f1c",setup(o){const n=d([]),t=d([]);return t.value=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake"}]},{value:"ningbo",label:"Ningbo",children:[{value:"dongqianlake",label:"Dongqian Lake"}]},{value:"wenzhou",label:"Wenzhou",children:[{value:"jiangxinpark",label:"Jiangxin Park"}]}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men"}]}]}],(g,p)=>{const l=y("CascaderRadio");return F(),u(l,{class:"m-10px",value:r(n),"onUpdate:value":p[0]||(p[0]=a=>B(n)?n.value=a:null),options:r(t)},{label:e(({data:a})=>[i("span",null,C(a.label),1)]),_:1},8,["value","options"])}}}),f=c({__name:"cascader-radio.md.demo.659f4f1d",setup(o){const n=d([]),t=d([]);return t.value=[{value:"zhejiang",label:"Zhejiang",children:[{value:"hangzhou",label:"Hangzhou",children:[{value:"xihu",label:"West Lake"}]},{value:"ningbo",label:"Ningbo",children:[{value:"dongqianlake",label:"Dongqian Lake"}]},{value:"wenzhou",label:"Wenzhou",children:[{value:"jiangxinpark",label:"Jiangxin Park"}]}]},{value:"jiangsu",label:"Jiangsu",children:[{value:"nanjing",label:"Nanjing",children:[{value:"zhonghuamen",label:"Zhong Hua Men"}]}]}],(g,p)=>{const l=y("CascaderRadio");return F(),u(l,{class:"m-10px",value:r(n),"onUpdate:value":p[0]||(p[0]=a=>B(n)?n.value=a:null),options:r(t)},{label:e(({data:a})=>[i("span",null,C(a.label),1)]),_:1},8,["value","options"])}}}),b=c({__name:"cascader-radio.md.demo.659f4f1e",setup(o){const n=d([]),t=d([]),g=d(!1);function p(l,a){setTimeout(()=>{if(l){!l.children&&(l.children=[]);const h=[...l.children];for(let k=a*10;k<a*10+10;k++)h.push({value:"zhejiang"+k+Math.random(),label:"Zhejiang"+k,isLeaf:!0});l.children=h}else for(let h=a*10;h<a*10+10;h++)t.value.push({value:"zhejiang"+h+Math.random(),label:"Zhejiang-text"+h,isLeaf:!1});a===1&&(l&&(l.isfinished=!0),!l&&(g.value=!0))},1e3)}return(l,a)=>{const h=y("CascaderRadio");return F(),u(h,{class:"m-10px",value:r(n),"onUpdate:value":a[0]||(a[0]=k=>B(n)?n.value=k:null),options:r(t),"is-finished":r(g),lazy:!0,loadData:p},{label:e(({data:k})=>[i("span",null,C(k.label),1)]),_:1},8,["value","options","is-finished"])}}}),_=c({__name:"cascader-radio.md.demo.659f4f1f",setup(o){const n=d([]),t=d([]),g=d(!1);function p(l,a){setTimeout(()=>{if(l){!l.children&&(l.children=[]);const h=[...l.children];for(let k=a*10;k<a*10+10;k++)h.push({value:"zhejiang"+k+Math.random(),label:"Zhejiang"+k,isLeaf:!0});l.children=h}else for(let h=a*10;h<a*10+10;h++)t.value.push({value:"zhejiang"+h+Math.random(),label:"Zhejiang"+h,isLeaf:!1});a===1&&(l&&(l.isfinished=!0),!l&&(g.value=!0))},1e3)}return(l,a)=>{const h=y("CascaderRadio");return F(),u(h,{class:"m-10px",value:r(n),"onUpdate:value":a[0]||(a[0]=k=>B(n)?n.value=k:null),options:r(t),"is-finished":r(g),lazy:!0,loadData:p},{label:e(({data:k})=>[i("span",null,C(k.label),1)]),_:1},8,["value","options","is-finished"])}}}),j=m('<h1 id="cascaderradio" tabindex="-1">CascaderRadio <a class="header-anchor" href="#cascaderradio" aria-label="Permalink to &quot;CascaderRadio&quot;">​</a></h1><p>一个只能单选的级联选择器 <br></p><p>特点：</p><ul><li>支持选项中使用插槽</li><li>支持选项当前页懒加载以及下一页懒加载</li></ul><h2 id="源文件" tabindex="-1">源文件 <a class="header-anchor" href="#源文件" aria-label="Permalink to &quot;源文件&quot;">​</a></h2><div class="un-prefer-unocss"></div><p><a href="https://github.com/shiouhoo/hooui/blob/main/src/package/cascader/Index.vue" target="_blank" rel="noreferrer">CascaderRadio.vue</a></p><div class="prefer-unocss"></div><p><a href="https://github.com/shiouhoo/hooui/blob/main/src/package/cascader-unocss/Index.vue" target="_blank" rel="noreferrer">CascaderRadio.vue</a></p><div class="warning custom-block"><p class="custom-block-title">WARNING</p><p>cascader-radio使用了fit-content，但是 &#39;width: fit-content&#39; is not supported by Firefox, Firefox for Android. Add &#39;width: -moz-fit-content&#39; to support Firefox 3+, Firefox for Android 4+.</p></div><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to &quot;示例&quot;">​</a></h2><h3 id="插槽" tabindex="-1">插槽 <a class="header-anchor" href="#插槽" aria-label="Permalink to &quot;插槽&quot;">​</a></h3><div class="un-prefer-unocss"></div>',13),z=i("div",{class:"language-vue vp-adaptive-theme"},[i("span",{class:"lang"},"vue"),i("pre",{class:"shiki shiki-themes github-light github-dark vp-code","v-pre":""},[i("code",null,[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"<"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}}," setup"),i("span",{style:{"--shiki-light":"#6F42C1","--shiki-dark":"#B392F0"}}," lang"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"="),i("span",{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"}},'"ts"'),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"        </"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"    </"),i("span",{style:{"--shiki-light":"#B31D28","--shiki-dark":"#FDAEB7","--shiki-light-font-style":"italic","--shiki-dark-font-style":"italic"}},"CascaderRadio"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"template"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1),J=i("h2",{id:"props-参数",tabindex:"-1"},[s("props 参数 "),i("a",{class:"header-anchor",href:"#props-参数","aria-label":'Permalink to "props 参数"'},"​")],-1),T=i("h2",{id:"事件",tabindex:"-1"},[s("事件 "),i("a",{class:"header-anchor",href:"#事件","aria-label":'Permalink to "事件"'},"​")],-1),W=i("h2",{id:"插槽-1",tabindex:"-1"},[s("插槽 "),i("a",{class:"header-anchor",href:"#插槽-1","aria-label":'Permalink to "插槽"'},"​")],-1),V=JSON.parse('{"title":"CascaderRadio","description":"","frontmatter":{"outline":[2,3]},"headers":[],"relativePath":"package/cascader-radio.md","filePath":"package/cascader-radio.md"}'),H={name:"package/cascader-radio.md"},S=c({...H,setup(o){const n=[{name:"value(v-model)",desc:"选中项",type:"(string | number)[]",defaultValue:"-"},{name:"options",desc:"下拉菜单数据",type:"Record<string, any>[]",defaultValue:"[]"},{name:"changeOnSelect",desc:"是否允许选中任意一级菜单",type:"boolean",defaultValue:"false"},{name:"iconSize",desc:"图标大小，默认为20，单位为像素，用于计算图标位置",type:"number",defaultValue:"20"},{name:"loadData",desc:"懒加载数据的方法",type:"(label: Record<string, any> | undefined, pageNum:number) => void",defaultValue:"-"},{name:"lazy",desc:"是否懒加载,需要配合loadData使用",type:"boolean",defaultValue:"false"},{name:"isFinished",desc:"第一页数据是否加载完毕，其余页数据加载标识在上级options数据中,lazy为true时有效",type:"boolean",defaultValue:"false"}],t=[{name:"change",desc:"选中值改变时触发",params:"value: (string | number)[]"}],g=[{name:"label",desc:"选项的插槽，参数为当前选项的数据",params:"-"}];return(p,l)=>{const a=y("demo"),h=y("ParamsTable"),k=y("EmitTable"),D=y("SlotTable");return F(),v("div",null,[j,E(a,{customClass:"",sourceCode:`<script setup lang="ts">
...
`,options:"{}"},{highlight:e(()=>[z]),default:e(()=>[E(A)]),_:1}),x,E(a,{customClass:"",sourceCode:`<script setup lang="ts">
const value = ref<string[]>([]);
...
`,options:"{}"},{highlight:e(()=>[P]),default:e(()=>[E(_)]),_:1}),J,E(h,{data:n}),T,E(k,{data:t}),W,E(D,{data:g})])}}});export{V as __pageData,S as default};
